...
const ConfigureEndpoint = () => {
  ...
  const handleSaveEndpoint = (name, method, path, rule, token, headers, kind, template, outputFormat) => {
    ...
    const newEndpoints = Object.assign({}, endpoints, { [name]: { path, method, rule, token, headers, kind, template, outputFormat } })
